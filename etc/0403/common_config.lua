...
server_name        = "IOS越狱1区-西天取经-0403"   -------用于telnet服务器时显示服务器名称（运维同事根据服务器名称配置）
