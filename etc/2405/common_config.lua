...
current_area_id         = 164         -- 当前区号

register_account   = false  -- 是否开启账号注册功能(非官方服务器必须为false)
activate_account   = false  -- 是否开启账号激活功能(非官方服务器必须为false)

current_gift_type       = 5           ----礼包类型（1-oppo/VIVO，2-PP）
server_name        = "联想-联想-2服-2405"   -------用于telnet服务器时显示服务器名称（运维同事根据服务器名称配置）
