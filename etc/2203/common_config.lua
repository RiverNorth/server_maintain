...
server_name        = "IOS混合5区-如来神掌-2203"   -------用于telnet服务器时显示服务器名称（运维同事根据服务器名称配置）
