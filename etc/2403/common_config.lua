...
server_name        = "安卓2服-斗战胜佛-2403"   -------用于telnet服务器时显示服务器名称（运维同事根据服务器名称配置）
